    ...
    <>
      <div class="sticky bottom-0 left-0 md:top-0 md:left-0 md:w-80 md:m-0 bg-gray-200 md:rounded-r-lg">
        <nav class="flex flex-row md:flex-col border-t-2 md:border-t-0 md:min-h-screen p-4 justify-evenly md:justify-normal md:gap-2">
          ...
          <a
            href="/meal-planner"
            class={`flex flex-row gap-3 hover:bg-gray-300 p-1 md:rounded-md ${document.title == "Meal Planner" ? "border-b-white border-b-2 md:border-l-white md:border-b-0 md:border-l-2" : ""}`}
          >
            {/* <img src={list} alt="home icon" /> */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="hidden md:block">Meal Planner</p>
          </a>
          <a
            href="/recipe"
            class={`flex flex-row gap-3 hover:bg-gray-300 p-1 md:rounded-md ${document.title == "Meal Planner" ? "border-b-white border-b-2 md:border-l-white md:border-b-0 md:border-l-2" : ""}`}
          >
            ...
            <p class="hidden md:block">Recipe</p>
          </a>
          <a
            href="/recipes"
            class={`flex flex-row gap-3 hover:bg-gray-300 p-1 md:rounded-md ${document.title == "Meal Planner" ? "border-b-white border-b-2 md:border-l-white md:border-b-0 md:border-l-2" : ""}`}
          >
            ...
            <p class="hidden md:block">Recipes</p>
          </a>
          <a
            href="/goal-planner"
            class={`flex flex-row gap-3 hover:bg-gray-300 p-1 md:rounded-md ${document.title == "Meal Planner" ? "border-b-white border-b-2 md:border-l-white md:border-b-0 md:border-l-2" : ""}`}
          >
            ...
            <p class="hidden md:block">Goal Planner</p>
          </a>
        </nav>
      </div>
    </>
